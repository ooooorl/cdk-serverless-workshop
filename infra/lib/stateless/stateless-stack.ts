  ...
  private createApiGatewayConstruct(props: StatelessStackProps): void {
    this.apiGatewayConstruct = new ApiGatewayConstruct(
      ...
      `${props.stage}-ApiGatewayConstruct`,
      {
        ...
        deleteTodoIntegration: this.lambdaConstruct.deleteTodoIntegration,
        getTodoIntegration: this.lambdaConstruct.getTodoIntegration,
        getTodosIntegration: this.lambdaConstruct.getTodosIntegration,
        updateTodoIntegration: this.lambdaConstruct.updateTodoIntegration,
      },
    );
  }
}
